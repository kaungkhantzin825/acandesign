...
/* ══════════════════════════════════════════════════════════
   KPO-PAGE.PHP SECTION (merged from kpo-page.php)
   KPOサービス — matched to Canva design page 15
   ══════════════════════════════════════════════════════════ */
:root {
    --kpo-navy: #000048;
    --kpo-ink: #002548;
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <main id="main">
        ...
        <section class="svc-section">
          <div class="svc-grid">
            ...
            <div class="svc-card svc-card--navy">
              ...
              <a href="#bpo-services" class="svc-card__btn">
            ...
            <div class="svc-card svc-card--green">
              ...
              <a href="#kpo-services" class="svc-card__btn">
    ...
    <!-- ========================================================== -->
    <!-- DESIGN SECTION (imported from case-design.php)                 -->
    <!-- デザインチーム（Graphic & Motion）                              -->
    <!-- ========================================================== -->
    <style>
        /* ── Scoped to .dsg (page-level nav/footer overrides from case-design.php omitted) ── */
        /* =========================================================
    ...
    <div class="dsg" id="design-team">
        ...
        <section class="dsg-sec dsg-sec--tint">
            <div class="dsg__inner">
                ...
                <div class="dsg-dl-banner">
                    <p class="dsg-dl-banner__text">ミャンマーデザインチームの資料はこちら→</p>
                    <a href="assets/pdf/デザインチーム営業資料.pdf" class="dsg-dl-banner__btn">ダウンロード</a>
                </div>
            </div>
    ...
    <!-- BPOサービス                                                   -->
    <!-- ========================================================== -->
    <div class="bpo-page" id="bpo-services">
    ...
    <!-- ========================================================== -->
    <!-- KPO-PAGE.PHP SECTION (imported from kpo-page.php)             -->
    <!-- KPOサービス                                                    -->
    <!-- ========================================================== -->
    <div class="kpo-page" id="kpo-services">
